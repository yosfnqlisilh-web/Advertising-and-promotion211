...
export const services = [
  { 
    ...
    longDescription: "نقدم حلولاً متكاملة لتطوير وتجديد واجهات المباني التجارية والسكنية باستخدام أفضل أنواع ألواح الكلادينج المقاومة للحريق والظروف الجوية القاسية في الرياض. نجمع بين جمال التصميم وقوة التنفيذ لضمان واجهة تعكس هوية مشروعك. يمكنك الاطلاع على <a href='/blog/how-to-choose-cladding-colors-for-villa' class='text-yellow-500 underline'>دليل اختيار الألوان</a> لتنسيق واجهة فيلتك بشكل احترافي.",
    features: [
  ...
  { 
    ...
    longDescription: "اللوحة هي عنوان نجاحك. في فن الإعلان، نتخصص في صناعة اللوحات الإعلانية التي تخطف الأنظار. نستخدم أحدث التقنيات في صناعة الحروف البارزة المضيئة (LED) بمواد متنوعة. نضمن لك الالتزام الكامل بـ <a href='/blog/riyadh-municipality-conditions' class='text-yellow-500 underline'>شروط بلدية الرياض الجديدة</a> لضمان عدم وجود مخالفات.",
    features: [

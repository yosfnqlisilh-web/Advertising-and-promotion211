...
export const testimonials = [
  { name: "شركة أساس", title: "مقاولات عامة", text: "قمنا بتجديد واجهة للمبنى التجاري الخاص بنا. العمل كان منظم والمواعيد دقيقة. شكرًا لفريق فن الإعلان على الاحترافية.", platformLogo: "https://i.imgur.com/83UcyCK.png" },
  { name: "م. عبد العزيز", title: "استشاري هندسي", text: "تعاملت معهم في عدة مشاريع لتنفيذ لوحات إعلانية. الجودة جيدة والتركيب يتم بشكل آمن وسريع. أنصح بهم.", platformLogo: "https://i.imgur.com/cUTwVzl.png" },
  { name: "متجر أزهار", title: "تجارة التجزئة", text: "اللوحة الجديدة للمحل أعطت هوية مميزة للمكان. التصميم كان بسيط وجميل. سعيد جدًا بالنتيجة النهائية.", platformLogo: "https://i.imgur.com/2s2XobD.png" },
  { name: "مطعم ركن الشام", title: "قطاع الأغذية", text: "خدمة جيدة وأسعارهم منافسة. تم تسليم اللوحة في الوقت المتفق عليه. عمل متقن.", platformLogo: "https://i.imgur.com/83UcyCK.png" },
  { name: "خالد السالم", title: "مالك عقار", text: "ركبت كلادينج لواجهة العمارة السكنية. الشكل النهائي كان جيد جدًا وأضاف قيمة للعقار. الضمان على الألوان مطمئن.", platformLogo: "https://i.imgur.com/eN8eB3D.png" },
];
